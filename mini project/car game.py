...
carimg = pygame.image.load('C:\\Users\\123\\Downloads\\car8.jpg')
...
def game_intro():
    load('C:\\Users\\123\\Downloads\\background1 (1).jpg', 0, 0)
    gameintro = False
...
def back():
    blue_strip = pygame.image.load('C:\\Users\\123\\Downloads\\download12.jpg')
...
def other_car(y_en):
    enemy1 = pygame.image.load('C:\\Users\\123\\Downloads\\car2.png')
    enemy = pygame.transform.scale(enemy1, (70, 100))
    global x_en
    if y_en == 0:

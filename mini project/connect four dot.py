...
BLACK = (0, 0, 0)  # red=0,green=0,blue=255
RED = (255, 0, 0)
YELLOW = (255, 255, 0)  # yellow=red+green

ROW_COUNT = 6  # row=6
COLUMN_COUNT = 7  # column = 7


def create_board():
    board = np.zeros((ROW_COUNT, COLUMN_COUNT))  # np = numpy
    return board
    ...
    for c in range(COLUMN_COUNT - 3):
        for r in range(ROW_COUNT - 3):
            if board[r][c] == piece and board[r + 1][c] == piece and board[r + 2][c] == piece and board[r + 3][
                ...
                # Check negatively slopped diagonols
    for c in range(COLUMN_COUNT - 3):
            ...
            if turn == 0:
                ...
                if is_valid_location(board, col):
                    ...
                    if winning_move(board, 1):
                        label = myfont.render("Player1 win!!", 1, RED)
            ...
            # ASk for player2 input
                ...
                if is_valid_location(board, col):
                    ...
                    if winning_move(board, 2):
                        label = myfont.render("Player2 win!!", 1, YELLOW)
                        screen.blit(label, (40, 10))
                        game_over = True
